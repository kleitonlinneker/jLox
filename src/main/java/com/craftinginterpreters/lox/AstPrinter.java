...
class AstPrinter implements Expr.Visitor<String> {
    ...
    @Override
    public String visitVariableExpr(Expr.Variable expr) { //Adicionado para teste
        return expr.name.lexeme;
    }

    @Override
    public String visitAssignExpr(Expr.Assign expr) { //Adicionado para teste
        return parenthesize("assign " + expr.name.lexeme, expr.value);
    }

    @Override
    public String visitLogicalExpr(Expr.Logical expr) { //Adicionado para teste
    ...
    @Override
    public String visitSetExpr(Expr.Set expr) { //Adicionado para teste
